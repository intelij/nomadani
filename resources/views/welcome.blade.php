                ...
                <div class="col-md-6">
                    <div class="svg-mask-container">
                        <svg version="1.1" id="p.svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 980.2914 884.5557" enable-background="new 0 0 980.2914 884.5557" xml:space="preserve">
                           <path opacity="0.05" fill="#CCA43D" d="M493.9887,130.1238L493.9887,130.1238C419.5373,4.797,257.8407-37.3296,131.6182,36.1312
                            ...
                            <path fill="none" stroke="#CCA43D" stroke-width="3.1978" stroke-miterlimit="10" d="M151.0414,716.6817L151.0414,716.6817
                            ...
                            <path fill="none" stroke="#CCA43D" stroke-width="2.7402" stroke-miterlimit="10" d="M186.6779,44.1803L186.6779,44.1803
                            ...
                            <path fill="none" stroke="#CCA43D" stroke-width="2.5752" stroke-miterlimit="10" d="M978.3951,400.8979
                            ...
                            <g>
                                <path fill="none" stroke="#CCA43D" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10" d="M747.8805,524.349
        ...
        <div class="container spacer-one-bottom-lg">
            ...
            <div class="row  justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="mb-3 pb-3">
                        <h5 class="mb-0"> When Noma Ndlovu Met Dani Moyo</h5>
                        ...
                        <li>
                            <div class="story-icon bg-icon-primary">
                                <svg version="1.1" class="icon-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 107 93" enable-background="new 0 0 107 93" xml:space="preserve">
                                 <path fill="#CCA43D" d="M53.6825,9.4436L53.6825,9.4436C41.6532-2.4793,22.2392-2.5,10.1866,9.4439
            ...
            <div class="row  justify-content-center">
                        ...
                        <div class="svg-mask-container">
                            <svg width="100%" height="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 607 532" enable-background="new 0 0 607 532" xml:space="preserve">
                              <defs>
                                ...
                                <image mask="url(#mask-small-2)" width="607" height="532" xlink:href="assets/img/mask-md-01.jpg" />
                           </svg>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12 text-center">
                    <div class="">
                        <h5 class="mb-0"> Happy ending we are getting married</h5>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 d-flex mb-4 mb-lg-0 display-state ">
                    <div class="card card-icon-2 card-body justify-content-between">
                        <img class="bg-image" src="assets/img/1b.jpeg" alt="">
                    </div>
                </div>
            ...
            <div class="col-lg-11 mx-lg-auto">
                <div class="row justify-content-center card-gutters">
                    <div class="col-7 mb-3">
                        <a href="assets/img/offset/large/1.png" class="popup-image hover-effect d-block">
                            <img class="img-fluid" src="assets/img/offset/1.png" alt="">
                            <span class="hover-effect-container">
                              <span class="hover-effect-icon has-svg">
                                 <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    ...
                                    <g>
                                       <path fill="#CCA43D" d="M36.904,6.66L36.904,6.66C28.5329-1.7395,14.9401-1.8373,6.4502,6.4736
                    ...
                    <div class="col-5 align-self-end mb-3">
                        <a href="assets/img/offset/large/2.png" class="popup-image hover-effect d-block">
                            <img class="img-fluid" src="assets/img/offset/2.png" alt="">
                            <span class="hover-effect-container">
                              <span class="hover-effect-icon has-svg">
                                 <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                      viewBox="0 0 73.6404 64.5606" enable-background="new 0 0 73.6404 64.5606" xml:space="preserve">
                    ...
                    <div class="col-5">
                        <a href="assets/img/offset/large/3.png" class="popup-image hover-effect d-block">
                            <img class="img-fluid" src="assets/img/offset/3.png" alt="">
                            <span class="hover-effect-container">
                              <span class="hover-effect-icon has-svg">
                                 <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                      viewBox="0 0 73.6404 64.5606" enable-background="new 0 0 73.6404 64.5606" xml:space="preserve">
                    ...
                    <div class="col-3">
                        <a href="assets/img/offset/large/4.png" class="popup-image hover-effect d-block">
                            <img class="img-fluid" src="assets/img/offset/4.png" alt="">
                            <span class="hover-effect-container">
                              <span class="hover-effect-icon has-svg">
                                 <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                      viewBox="0 0 73.6404 64.5606" enable-background="new 0 0 73.6404 64.5606" xml:space="preserve">
                    ...
                    <div class="col-3">
                        <a href="assets/img/offset/large/5.png" class="popup-image hover-effect d-block">
                            <img class="img-fluid" src="assets/img/offset/5.png" alt="">
                            <span class="hover-effect-container">
                              <span class="hover-effect-icon has-svg">
                                 <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                      viewBox="0 0 73.6404 64.5606" enable-background="new 0 0 73.6404 64.5606" xml:space="preserve">
        ...
        <div class="container spacer-double-lg">
            <div class="row justify-content-between z-index-3 position-relative align-items-center">
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <p class="lead text-white mb-0"> Your presence at our wedding is present enough but if we are honored with a gift from you, a <strong>monetary</strong> gift will be very much appreciated. </p>
                </div>
                <div class="col-md-5">
                    <h1 class="display-4 text-white">Accommodation</h1>
                    <p class="text-uppercase mb-5 font-weight-600 text-light upper-letter-space">To book visit Holiday Inn Wigston <a href="http://www.hileicesterwigston.com" style="color: #4c4c4c;" target="_blank">www.hileicesterwigston.com</a> <br/>with unique promo code <strong style="color: #4c4c4c;">NDLOVU</strong></p>
                </div>
            </div>
        </div>
    </section>
...
<g>
        ...
        <div class="svg-decoration-container">
            <div class="svg-decoration middle-left ">
                <svg width="100%" height="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 135.7427 125.4471" enable-background="new 0 0 135.7427 125.4471" xml:space="preserve">
                     <g>
                         <path fill="#CCA43D" d="M46.3709,123.4824c-0.718-1.036-1.9904-1.1435-3.1008-1.5854c-1.2856-0.5117-2.4638-1.1784-3.5942-1.9727
                         ...
                         <path fill="#CCA43D" d="M53.0453,115.3059c-4.4957-1.9741-16.933-9.8289-17.1288,0.5154c-0.0176,0.9304-1.339,0.8885-0.5229,1.3398
                           c4.3032,2.3803,8.8232,4.1526,13.4673,5.7454C50.2921,123.3976,54.4329,115.9152,53.0453,115.3059z" />
                         <path fill="#CCA43D" d="M62.0153,116.0416c-2.2559-8.7056-23.1343-17.659-29.0229-12.8535c-1.0698,0.873-2.0786,1.41-0.7908,2.0262
                           c9.4616,4.5257,18.9397,8.7919,28.2448,13.6547C62.0641,119.7142,62.4759,117.819,62.0153,116.0416z" />
                         <path fill="#CCA43D" d="M76.0122,107.4455c-5.951-10.7841-44.442-25.2437-50.1732-15.1986
                         ...
                         <path fill="#CCA43D" d="M83.7416,106.7034C78.3731,94.7113,29.5014,64.5428,19.746,80.4405
                         ...
                         <path fill="#CCA43D" d="M98.5164,101.8162C75.9046,83.6435,29.9653,64.7263,11.4555,66.8863
                         ...
                         <path fill="#CCA43D" d="M107.1592,96.1165C83.8287,79.3572,34.7819,55.1261,5.8419,55.6944
                         ...
                         <path fill="#CCA43D" d="M114.6054,91.6748c-18.5585-7.6446-37.8352-19.8791-56.4415-27.4064
                         ...
                         <path fill="#CCA43D" d="M122.1404,85.1791c-20.1722-8.1227-46.2771-24.6321-66.3275-33.0562
                         ...
                         <path fill="#CCA43D" d="M125.8786,79.2283c-20.4912-8.5128-39.3423-23.3619-59.7019-32.1852
                         ...
                         <path fill="#CCA43D" d="M130.2242,73.6163c-20.2535-10.3398-41.0253-19.7456-61.8777-28.8054
                         ...
                         <path fill="#CCA43D" d="M133.7529,64.5225C92.9384,44.6669,51.2215,25.7029,7.7763,12.2997
                         ...
                         <path fill="#CCA43D" d="M134.2905,55.923C94.9692,38.3296,54.6778,19.4975,13.2622,7.3866
                         ...
                         <path fill="#CCA43D" d="M67.0403,21.4345C51.8222,14.2468,35.3193,7.9447,19.1524,3.2534
                         ...
                         <path fill="#CCA43D" d="M57.3122,11.6418C57.4051,8.9267,34.2234-3.2668,28.3663,0.8357c-1.0556,0.7394-1.444,1.5195-0.4906,2.0276
                           c8.8657,4.7246,18.7788,8.4473,28.1739,12.0138C58.1769,15.6846,57.2371,13.8362,57.3122,11.6418z" />
                         <path fill="#CCA43D" d="M133.1648,47.7784c-14.3374-6.7709-29.4575-12.6714-44.4443-17.8448
                         ...
                         <path fill="#CCA43D" d="M128.0374,37.178c-8.7472-3.7643-17.9131-7.8857-27.2702-9.8305c-1.6177-0.336-1.8544,1.9524-0.63,2.6019
            ...
            <div class="svg-decoration bottom-right">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 61.0903 58.3236" enable-background="new 0 0 61.0903 58.3236" xml:space="preserve">
                     <g>
                         <g>
                             <path fill="#CCA43D" d="M35.9444,45.3305c-10.4863,0.4059-23.3154,1.1544-24.786-9.9408
                             ...
                             <g>
                                 <path fill="#CCA43D" d="M17.5292,2.3522c-3.0514,1.7301-4.9803,2.7768-5.9291,3.8411c-2.3624,2.6499-2.0799,2.8104-3.8628,5.1073
    ...
    <a class="scroll-to-top scroll" href="index.html#wrapper">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 273.1091 238.2098" enable-background="new 0 0 273.1091 238.2098" xml:space="preserve">
               <path fill="#CCA43D" d="M136.7428,23.457L136.7428,23.457C105.6324-7.6197,55.2286-7.8699,23.8161,23.0177
